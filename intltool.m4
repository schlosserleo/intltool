...
sed -e "s:@INTLTOOL_PERL@:${INTLTOOL_PERL}:;" < ${top_srcdir}/intltool-extract.in > intltool-extract.out
...
sed -e "s:@INTLTOOL_PERL@:${INTLTOOL_PERL}:;" < ${top_srcdir}/intltool-merge.in > intltool-merge.out
...
sed -e "s:@INTLTOOL_PERL@:${INTLTOOL_PERL}:;" < ${top_srcdir}/intltool-update.in > intltool-update.out

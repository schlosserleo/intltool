...
dnl  AC_OUTPUT
AC_OUTPUT_COMMANDS([
sed -e "s:@INTLTOOL_PERL@:${INTLTOOL_PERL}:;" < ${ac_given_srcdir}/xml-i18n-extract.in > xml-i18n-extract.out
...
sed -e "s:@INTLTOOL_PERL@:${INTLTOOL_PERL}:;" < ${ac_given_srcdir}/xml-i18n-merge.in > xml-i18n-merge.out
...
sed -e "s:@INTLTOOL_PERL@:${INTLTOOL_PERL}:;" < ${ac_given_srcdir}/xml-i18n-update.in > xml-i18n-update.out
